...
import { Home, ClipboardList, Users, UserCheck, BriefcaseBusiness, FileText, Send, FilePenLine } from 'lucide-react'
...
const items = [
  ...
  ['/offers', 'العروض الوظيفية', Send],
  ['/onboarding', 'مباشرة العمل', BriefcaseBusiness],
  ['/onboarding/manage', 'إدارة المباشرات', FilePenLine],
